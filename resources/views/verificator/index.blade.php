            ...
            <div class="card-body px-4 py-4-5">
              <div class="row">
                ...
                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                  <h6 class="text-muted font-semibold">Form Data Ibu Hamil</h6>
                  {{-- <h6 class="font-extrabold mb-0">{{$getKlasifikasiCount}}</h6> --}}
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body px-4 py-4-5">
              <div class="row">
                ...
                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                  <h6 class="text-muted font-semibold">Form Data Suami</h6>
                  {{-- <h6 class="font-extrabold mb-0">{{$getInstansiCount}}</h6> --}}
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body px-4 py-4-5">
              <div class="row">
                ...
                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                  <h6 class="text-muted font-semibold">Form Data Penilaian</h6>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Grafik Kematian Ibu Hamil</h4>
            </div>
            <div class="card-body">
              <div id="chart-profile-visit">222</div>
            </div>
          </div>
        </div>
      </div>
