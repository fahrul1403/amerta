...
<body>
    ...
    <div class="w-full lg:max-w-4xl lg:ml-72 lg:px-5 mt-7 relative overflow-y-hidden">
        {{-- Toast Notification --}}
       ...
       <h1 class="text-sm font-bold text-primary"> Data Tabel : <span class="p-2  rounded-lg"> ( {{$getDataPenilaianCount}} )</span></h1>
        <a href="{{ route('datapenilaian.create') }}" class="bg-primary py-3 px-6 rounded-xl text-white font-medium flex items-center gap-2">
    ...
    <br>
    <div class="relative justify-center overflow-x-auto shadow-md sm:rounded-lg w-max-3xl">


        {{-- Table --}}
        <table class="odd:bg-white ml-16 odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 text-center max-w-4xl mb-3 overflow-y-hidden">
