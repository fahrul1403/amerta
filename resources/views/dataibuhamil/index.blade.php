...
<body>
    ...
    <div class="w-4xl lg:max-w-5xl lg:ml-72 lg:px-5 mt-7 relative">
        {{-- Toast Notification --}}
        ...
        <div class="mt-7 mb-5 flex items-center justify-between bg-gray-200 p-2 rounded-lg relative ">
            ...
            <a href="{{ route('dataibuhamil.create') }}" class="bg-primary py-3 px-6 rounded-xl text-white font-medium flex items-center gap-2">
                ...
                <tbody class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 text-center ">
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 text-center w-full">
                        ...
                        <td class="px-6 py-4 flex justify-center items-center gap-2">
                            ...
                            <a href="{{ url('/dashboard/admin/dataibuhamil/show', $hasil->id) }}" class="font-medium text-white py-2 px-2  bg-emerald-500 flex items-center gap-2 rounded-lg ">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            ...
                            <a href="{{ url('/dashboard/admin/dataibuhamil/edit', $hasil->id)  }}" class="font-medium text-white py-2 px-2  bg-amber-500 flex items-center gap-2 rounded-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                </svg>
                            </a>

                            <form action="{{ route('dataibuhamil.destroy', $hasil->id) }}" method="POST" class="flex items-center gap-2">
                                @csrf
                                @method('DELETE')
                        ...
                        <td class="px-3 py-3 flex justify-center items-center gap-1">
                            <a href="{{ route('dataibuhamil.create_penilaian', $hasil->id) }}" class="bg-primary py-3 px-3 rounded-xl text-white font-medium flex items-center gap-2 -ml-2">
