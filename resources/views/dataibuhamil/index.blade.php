...
<body>
    ...
    <div class="container-fluid w-4xl lg:max-w-5xl lg:ml-72 lg:px-5 mt-7 relative">
        {{-- Toast Notification --}}
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
            ...
            <table
                ...
                <tbody
                    ...
                    @foreach ($dataibuhamil as $no => $hasil)
                        <tr
                            ...
                            <td class="px-6 py-4">{{ $hasil->pekerjaan }}</td>
                            <td class="px-6 py-4">{{ $hasil->noHP }}</td>
                            <td class="px-6 py-4 flex justify-center items-center gap-2">
                                {{-- @if (Auth::user()->isAdmin()) --}}
                                <a href="{{ url('/dashboard/admin/dataibuhamil/show', $hasil->id) }}"
                                ...
                                <a href="{{ url('/dashboard/admin/dataibuhamil/edit', $hasil->id) }}"
                                ...
                                <form action="{{ route('dataibuhamil.destroy', $hasil->id) }}" method="POST"
                                    class="flex items-center gap-2">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                                        class="font-medium text-white py-2 px-2  bg-red-500  flex items-center gap-2 rounded-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <td class="px-3 py-3 flex justify-center items-center gap-1">
                                <a href="{{ route('dataibuhamil.create_penilaian', $hasil->id) }}"
