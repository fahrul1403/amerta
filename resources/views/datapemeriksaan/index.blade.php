...
<body>
    ...
    <div class="w-full lg:max-w-3xl lg:ml-72 lg:px-5 mt-7 relative">
        {{-- Toast Notification --}}
        @if (session()->has('success'))
        <div id="toast-success" class="absolute flex justify-end right-0 items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 animate_animated animate_bounceInRight" role="alert">
        ...
        <div class="mt-7 mb-5 flex items-center justify-between bg-gray-200 p-2 rounded-lg relative">
            <h1 class="text-sm font-bold text-primary"> Data Tabel : <span class="p-2 rounded-lg"> ( {{ $getdatapenilaianibuhamilCount }} )</span></h1>
        </div>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full">
            {{-- Table --}}
            <table class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 text-center mb-3">
                ...
                <tbody class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 text-center">
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 text-center w-full">
                        ...
                        <td class="px-6 py-4 flex justify-center items-center gap-2">
                            ...
                            <a href="{{ route('datapemeriksaan.shows', $hasil->data_ibu_hamil_id) }}" class="bg-primary py-3 px-3 rounded-xl text-white font-medium flex items-center gap-2 -ml-2">
