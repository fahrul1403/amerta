...
<div class="flex justify-end gap-2 items-center  lg:max-w-5xl lg:ml-72 px-5 mt-7  ">
  ...
  <!-- Small Modal -->
  <div id="small-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden max-w-md p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
