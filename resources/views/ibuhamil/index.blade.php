                ...
                <tbody
                    ...
                    @foreach ($datas as $no => $hasil)
                        <tr
                            ...
                            <td class="px-6 py-4 flex justify-center items-center gap-2">
                                <a href="{{ url('/dashboard/admin/datapenilaianibuhamil/show', $hasil->id) }}"
                                ...
                                <a href="{{ url('/dashboard/admin/datapenilaianibuhamil/edit', $hasil->id) }}"
                                ...
                                <form method="POST"
                                    action="{{ url('/dashboard/admin/datapenilaianibuhamil/delete', $hasil->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
